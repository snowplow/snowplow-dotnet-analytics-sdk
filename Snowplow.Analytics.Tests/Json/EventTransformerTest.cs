...
namespace Snowplow.Analytics.Tests.Json
{
    public class EventTransformerTest
    {
        ...
        private static readonly Dictionary<string, string> _input = new Dictionary<string, string>(){
                { "app_id", "angry-birds"},
                { "platform", "web"},
        ...
        [Fact]
        public void TestMultipleMalformedField()
        {
            ...
            Assert.Equal(2, exception.ErrorMessage.Count());
        }

...
namespace Snowplow.Analytics.Tests.Json
{
    public class EventTransformerTest
    {
        ...
        private Dictionary<string, string> GetInputWithContextAndUnstructEventAndUserAgentWithQuotes()
        {
            var d = GetInputWithContextAndUnstructEvent();
            d["useragent"] = "Mozilla/5.0 (Linux; Linux x86_64) Gecko/20100101 Firefox/59.7 (\\\"Extra Info\\\")";
            return d;
        }

        private string GetSerializedExpectedOutputForInputWithContextAndUnstructEventAndUserAgentWithQuotes()
        {
            var expected = JObject.Parse(@"{
                'geo_location' : '37.443604,-122.4124',
                'app_id' : 'angry-birds',
                ...
                'pp_yoffset_min' : null,
                'pp_yoffset_max' : null,
                'useragent' : 'Mozilla/5.0 (Linux; Linux x86_64) Gecko/20100101 Firefox/59.7 (""Extra Info"")',
                'br_name' : null,
                'br_family' : null,
                'br_version' : null,
                'br_type' : null,
        ...
        protected void TestMultipleMalformedField()
        {
            ...
            var expectedExceptions = new List<string>() {
                ...
                "Unexpected exception parsing field with key tr_tax_base and value bad_tax_base: The input string 'bad_tax_base' was not in a correct format."
                };
        ...
        [Fact]
        public void TestQuotesInUserAgentString()
        {
            var input = GetInputWithContextAndUnstructEventAndUserAgentWithQuotes();
            var expected = GetSerializedExpectedOutputForInputWithContextAndUnstructEventAndUserAgentWithQuotes();

...
namespace Snowplow.Analytics.Tests.Json
{
    public class EventTransformerTest
    {
        ...
        private Dictionary<string, string> GetInputWithContextAndUnstructEventQuoteAgent()
        {
            ...
            //d["useragent"] = "Mozilla/5.0 (Linux; Android 9; SM-G950U Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/97.0.4692.98 Mobile Safari/537.36 (\"Affirm-Android-3.120.6-556\")";
            return d;
        }
        ...
        {
            var input = GetInputWithContextAndUnstructEventQuoteAgent();
            var expected = GetSerializedExpectedOutputForInputWithContextAndUnstructEventQuoteAgent();

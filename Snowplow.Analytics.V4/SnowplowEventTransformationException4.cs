...
public class SnowplowEventTransformationException4 : Exception
{
    /// <summary>
    ...
    public SnowplowEventTransformationException4(List<string> messages)
        : base(ConvertListToStringSequence(messages))
    {
        ErrorMessages = messages;
    }

    public SnowplowEventTransformationException4(string message)
        : base(message)
    {

...
namespace Snowplow.Analytics.V2
{
    ...
    /// </summary>
    public static class JsonShredder2
    {
        ...
        private static Dictionary<string, string> ExtractSchema(string uri)
        {
            ...
            {
                throw new SnowplowEventTransformationException2($"Schema {uri} does not conform to schema pattern.");
            }
        ...
        public static Func<string, JObject> ParseContexts = (contextJsons) =>
        {
            ...
            if (data == null)
            {
                throw new SnowplowEventTransformationException2("Could not extract data field from custom context.");
            }
            ...
            foreach (var context in data)
            {
                ...
                catch (SnowplowEventTransformationException2 e)
                {
            ...
            {
                throw new SnowplowEventTransformationException2(errors.ToList());
            }
        ...
        public static Func<string, JObject> ParseUnstruct = (unstruct) =>
        {
            ...
            if (data == null)
            {
                throw new SnowplowEventTransformationException2("Could not extract data field from unstructured event.");
            }

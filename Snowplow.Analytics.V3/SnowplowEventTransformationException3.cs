...
{
    public class SnowplowEventTransformationException3 : Exception
    {
        /// <summary>
        ...
        public SnowplowEventTransformationException3(List<string> messages)
            : base(ConvertListToStringSequence(messages))
        {
            ErrorMessages = messages;
        }

        public SnowplowEventTransformationException3(string message)
            : base(message)
        {
